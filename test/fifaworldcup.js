...
contract('FifaWorldCup', function (accounts) {
  ...
  it("Worldcup addGame testing", function () {
    return FifaWorldcup.deployed().then(function (instance) {
      ...
      return worldcupInstance.addGame("Russia", "Saudi Arabia", parseInt(Date.now() / 1000) + 600, { from: accounts[0] });
    }).then(function () {
  ...
  it("cast vote 1", function () {
    return FifaWorldcup.deployed().then(function (instance) {
      ...
      return instance.castVote(0, 1, { from: accounts[1], value: 1000000000000000000 });
    }).then(function (returnValue) {
      console.log("success");
    });
  });
  it("cast vote 2", function () {
    return FifaWorldcup.deployed().then(function (instance) {
      return instance.castVote(0, 2, { from: accounts[2], value: 1000000000000000000 });
    }).then(function (returnValue) {
      console.log("success");
    });
  });
  it("cast vote 3", function () {
    return FifaWorldcup.deployed().then(function (instance) {
      return instance.castVote(0, 3, { from: accounts[3], value: 1000000000000000000 });
    }).then(function (returnValue) {
      console.log("success");
    });
  });
  it("cast vote 4", function () {
    return FifaWorldcup.deployed().then(function (instance) {
      return instance.castVote(0, 1, { from: accounts[4], value: 1000000000000000000 });
    }).then(function (returnValue) {
      console.log("success");
    });
  });
